...
const Wio_BaseSchema = z
  .object({
    ...
    bulk_prices: z.string().max(4000).nullable().optional(),
...
const OfferingReportViewSchemaBase = z.object({
  ...
  wioBulkPrices: z.string().max(4000).nullable().optional(),
...
const OfferingEnrichedViewSchemaBase = z.object({
  ...
  offeringBulkPrices: z.string().max(4000).nullable().optional(),
