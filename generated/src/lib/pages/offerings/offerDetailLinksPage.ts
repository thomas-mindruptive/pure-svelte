// Data loading and business logic for the OfferDetailLinksPage
...
export async function load(_event: PageLoadEvent) {
    console.log(`Loading data for OfferDetailLinksPage with ID: ${_event.params.offerId}`);
    ...
    const pageData = {
        ...
        message: 'This is loaded data for OfferDetailLinksPage.'
    };
