...
export const OfferingDetailAttributes = z.object({
...
export const OfferingDetailAttributes_LoadDataSchema = OfferingDetailAttributes.extend({
...
export const OfferingDetailLinks_LoadDataSchema = OfferingDetailAttributes.extend({
